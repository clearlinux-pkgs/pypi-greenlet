...
Source0  : https://files.pythonhosted.org/packages/1e/1e/632e55a04d732c8184201238d911207682b119c35cecbb9a573a6c566731/greenlet-2.0.2.tar.gz
...
%prep
%setup -q -n greenlet-2.0.2
cd %{_builddir}/greenlet-2.0.2
pushd ..
cp -a greenlet-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674942622
