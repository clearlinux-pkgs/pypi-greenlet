...
Source0  : https://files.pythonhosted.org/packages/b0/9c/666d8c71b18d0189cf801c0e0b31c4bfc609ac823883286045b1f3ae8994/greenlet-3.2.0.tar.gz
...
%prep
%setup -q -n greenlet-3.2.0
cd %{_builddir}/greenlet-3.2.0
pushd ..
cp -a greenlet-3.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744741686
