...
Source0  : https://files.pythonhosted.org/packages/a0/d5/70772b3693f086a362f122516225a43fe4f1182e17158c81ba1ab271ab9b/greenlet-1.1.3.tar.gz
...
%prep
%setup -q -n greenlet-1.1.3
cd %{_builddir}/greenlet-1.1.3
pushd ..
cp -a greenlet-1.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661444714
