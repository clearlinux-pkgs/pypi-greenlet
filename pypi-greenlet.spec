...
Source0  : https://files.pythonhosted.org/packages/65/1b/3d91623c3eff61c11799e7f3d6c01f6bfa9bd2d1f0181116fd0b9b108a40/greenlet-3.1.0.tar.gz
...
%prep
%setup -q -n greenlet-3.1.0
cd %{_builddir}/greenlet-3.1.0
pushd ..
cp -a greenlet-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726063274
