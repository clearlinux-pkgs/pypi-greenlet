...
Source0  : https://files.pythonhosted.org/packages/c9/92/bb85bd6e80148a4d2e0c59f7c0c2891029f8fd510183afc7d8d2feeed9b6/greenlet-3.2.3.tar.gz
...
%prep
%setup -q -n greenlet-3.2.3
cd %{_builddir}/greenlet-3.2.3
pushd ..
cp -a greenlet-3.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749224168
