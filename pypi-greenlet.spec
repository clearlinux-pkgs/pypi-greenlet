...
Source0  : https://files.pythonhosted.org/packages/d4/e7/e41e5150909f58d3161b7ab680d17bb8d47dbbc45385f07a870164d3d02f/greenlet-2.0.0.post0.tar.gz
...
%prep
%setup -q -n greenlet-2.0.0.post0
cd %{_builddir}/greenlet-2.0.0.post0
pushd ..
cp -a greenlet-2.0.0.post0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667576457
