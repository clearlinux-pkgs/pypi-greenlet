...
Source0  : https://files.pythonhosted.org/packages/54/df/718c9b3e90edba70fa919bb3aaa5c3c8dabf3a8252ad1e93d33c348e5ca4/greenlet-3.0.1.tar.gz
...
%prep
%setup -q -n greenlet-3.0.1
cd %{_builddir}/greenlet-3.0.1
pushd ..
cp -a greenlet-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698244371
