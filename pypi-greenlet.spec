...
Source0  : https://files.pythonhosted.org/packages/23/6f/f72865c589d0c79f03b51520a4cdd65647de0513e9ad107a5731df89c235/greenlet-2.0.0.tar.gz
...
%prep
%setup -q -n greenlet-2.0.0
cd %{_builddir}/greenlet-2.0.0
pushd ..
cp -a greenlet-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667331327
